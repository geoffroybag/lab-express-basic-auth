...
app.use(session({
  // "resave" and "saveUninitialized" are just here to avoid warning messages
  resave : true,
...
app.use(flash())
// "app.use" defines Middleware functions (they run before ALL your routes)
app.use((req,res,next)=>{
  // send flash messages to the hbs file as "messages"
  res.locals.messages = req.flash()
  // you need this or your app won't work (load forever)
  next()
